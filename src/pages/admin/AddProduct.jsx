  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-2xl font-semibold text-secondary-900">Add Product</h1>
          <nav className="flex items-center text-sm mt-2">
            ...
            <FiChevronRight className="mx-2 text-secondary-400" />
            <span className="text-secondary-800">Add Product</span>
          </nav>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-sm">
        <div className="p-6 border-b border-secondary-100">
          ...
          <p className="text-secondary-600 text-sm mt-1">Add information about your new product.</p>
        </div>
